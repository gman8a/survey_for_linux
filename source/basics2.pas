unit basics2; { Only Stuff that is repetivly called by program }
interface
...
procedure menu_op2(op_set:all_char);

procedure input_real(var r:real);
...
procedure input(var r:real; f,d:integer);
  begin write(r:f:d,' ? '); input_real(r); end;
...
function get_dir(fn:string; pick:boolean):string;
  ...
  begin
    ...
    if j mod 5<>0 then writeln; for i:=1 to 80 do write('-'); writeln;
